...
from emlearn.cgen import array_declare
...
def export_dummy(estimator, name, **kwargs):
    ...
    code = """
    int model_predict(int16_t *features, int length) {
...
def generate_test_data(X, Y):
    ...
    code += '\n' + array_declare('testdata_values', values=X_flat, dtype='int16')
